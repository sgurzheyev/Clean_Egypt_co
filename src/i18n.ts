  ...
  en: {
    translation: {
      ...
      withdrawalConfirmBody:
        'You are withdrawing {{gross}} EGP. Platform fee (12%) is {{fee}} EGP. You will receive {{net}} EGP to your destination account.',
      withdrawalLineGross: 'Withdrawal amount: {{amount}} EGP',
      withdrawalLineFee: 'Platform fee (12%): {{fee}} EGP',
      withdrawalLineNet: 'You receive: {{net}} EGP',
      withdrawalBalanceHint:
        'Max withdrawal: {{max}} EGP (wallet minus {{frozen}} EGP frozen). 12% platform fee on payout.',
      ...
      coworker: 'Co-worker',
      frozen: 'Frozen',
      amountInUsd: 'Amount (EGP)',
      needDepositEgp: 'Need {{amount}} deposit to start',
      enterPositiveEgpAmount: 'Enter a positive amount in EGP.',
      homePriceRangeEgp: 'Home mission price must be between {{min}} and {{max}} EGP.',
      cityPriceRangeEgp: 'City mission goal must be between {{min}} and {{max}} EGP.',
