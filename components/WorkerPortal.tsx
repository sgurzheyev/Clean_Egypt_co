...
const WorkerPortal = () => {
  ...
  if (loading) return <div className="min-h-screen bg-slate-900 flex items-center justify-center text-teal-400 font-black tracking-widest">CLEANEGYPT LOADING...</div>;
