...
const JobMarker: React.FC<JobMarkerProps> = ({ amount, orderType, label, onClick }) => {
  ...
  return (
    <button
      ...
      className="relative flex flex-col items-center group cursor-pointer select-none outline-none border-0 p-0 bg-transparent"
    ...
    >
      ...
      <div
        className={[
          ...
          'px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-[0.12em]',
      ...
      >
        ...
        <div
          className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-16 h-4 rounded-full pyramid-glow pointer-events-none"
          aria-hidden
        />

        {/* Faceted pyramid — gemstone shape */}
        <div className="relative w-14 h-16 pyramid-shape flex items-start justify-center pt-1.5">
