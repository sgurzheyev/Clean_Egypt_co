...
> Hub: [[🗺️ GARBAGIN Master Index]] · canon: [[04_Roadmap_Tasks/Garbage_History_Lifecycle]] · money: [[01_Architecture/Stripe_USD_Flow]] · P2P: [[01_Architecture/P2P_Deal_Flow]] · security: [[01_Architecture/Security_and_RPCs]] · dashboard: [[04_Roadmap_Tasks/00_Dashboard]]
...
| P1-1 | Crowd `failed` is a dead end | Open |
| P1-2 | `process_abandoned_missions` re-tenders funded crowd jobs | Open |
...
4. `failed` recovery (P1-1)
5. Exclude crowdfunding from abandon retender (P1-2)
6. Stop writing USD into `amount_target` (P2-3)
7. History columns + n8n + R2 purge (after 1–2)
8. Profile / map list hygiene (P2-4)
