...
- Wave I (SEC-4 Vercel user JWT on AI / notify) → [[04_Roadmap_Tasks/Lifecycle_Fix_Wave_I]]
- Телефонный прод (отзывы / пин / шит) → [[04_Roadmap_Tasks/Phone_Prod_Reviews_Pin_Sheet]]
