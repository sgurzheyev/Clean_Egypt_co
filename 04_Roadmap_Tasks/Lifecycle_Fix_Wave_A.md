...
CLI history is messy — paste in the SQL Editor **after** P0 (full order: [[docs/LIFECYCLE_FIX_APPLY_RUNBOOK]]; mark applied: [[04_Roadmap_Tasks/Ops_Migration_History_Repair]]):
