-- Fix apply_stripe_contribution for Edge Function service-role RPC calls.
-- auth.jwt() ->> 'role' is often NULL when invoked via supabase-js service key,
-- causing "Service role only" even with a valid service_role client.
