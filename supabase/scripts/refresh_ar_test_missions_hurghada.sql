...
FROM me,
(VALUES
  -- status,      tokens, budget, funded, service_type,            lat,      lng,      crowdfunding, description
...
) AS t(status, amount_target, expected_price, current_funding, service_type, lat, lng, crowdfunding_mode, description);
