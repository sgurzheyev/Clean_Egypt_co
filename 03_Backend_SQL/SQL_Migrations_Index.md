...
| 2026-09-12 | [[20260912_split_expiry_and_first_donate_wake.sql]] | P0: $0 expiry quietly hides (no Gov Notice); first Stripe dollar wakes `reported` pins. Note: [[01_Architecture/P0_Split_Expiry_First_Donate]]. **Apply via SQL Editor** — CLI history is out of sync. Verify: [[../supabase/manual/20260912_p0_expiry_first_donate_verify.sql]]. |
